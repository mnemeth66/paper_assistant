...
from biorxiv_scraper import get_papers_from_biorxiv_api
...
def get_papers_from_arxiv(config):
    paper_set = set(get_papers_from_biorxiv_api())
    return paper_set
...
if __name__ == "__main__":
    ...
    if config["SELECTION"]["model_provider"] == "openai":
        client = OpenAI(api_key=OAI_KEY)
    if config["SELECTION"]["model_provider"] == "anthropic":
